...
export function MainCard() {
	return (
		<div className='drop-shadow-lg '>
			<div className='bg-card-background bg-no-repeat rounded-3xl bg-cover bg-center '>
				<div className='rounded-3xl bg-center bg-cover-card-background-desk bg-no-repeat bg-cover  tb:p-2 lg:p-9'>
					<div className='p-3'>
